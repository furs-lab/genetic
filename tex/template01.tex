		...
		\BLOCK{ for theme in panels[0]['themes']: }
			...
			\BLOCK{ for subtheme in theme['subthemes']: }
				...
				\BLOCK{ for risk in subtheme['risks']: }
					...
					&  
					\BLOCK{ if risk["risk_value"] == 'low'}
					V
					\cellcolor{blue!20}
					\BLOCK{ endif}    
					&
					\BLOCK{ if risk["risk_value"] == 'mid'}
					V
					\cellcolor{green!40}
					\BLOCK{ endif} 
					&   
					\BLOCK{ if risk["risk_value"] == 'high'}
					V
					\cellcolor{yellow!40}
					\BLOCK{ endif} 
					& 
					\BLOCK{ if risk["risk_value"] == 'upper'}
					V
					\cellcolor{red!50}
					\BLOCK{ endif}\\
					\hline
...
\BLOCK{ for theme in panels[0]['themes']: }
	...
	\textit{Рекомендации:}
		\BLOCK{ for subtheme in theme['subthemes']: }
			\BLOCK{ for risk in subtheme['risks']: }
				\BLOCK{ if risk["risk_value"] == 'upper' or risk["risk_value"] == 'high'}
